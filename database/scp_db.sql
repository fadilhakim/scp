...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `role`, `remember_token`, `created_at`, `updated_at`, `username`, `status`, `ip_address`, `user_agent`) VALUES
(1, 'Aries Dimas Yudhistira', 'alhusna901@gmail.com', '$2y$10$YT7NdLRsP/DiY9DCphPP8uNZDqe4YX99mcMz/8.2kfIi67gsmPa72', 'customer', NULL, '2018-01-31 08:23:30', '2018-01-31 08:23:30', 'alhusna901', 'active', '127.0.0.0', 'mozilla');
