               ...
               <div class="swiper-slide">
                    <div class="container">
                        ...
                        <div class="slider-product-preview">
                            <img src="{{ URL::asset('public/img/product-preview-4.jpg')}}" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-xs-b30 col-md-b0">
                    <div class="banner-shortcode style-6">
                        <img class="image" src="{{ URL::asset('public/img/product-130.jpg')}}" alt="" />
                        <div class="content">
                            <div class="cell-view">
                ...
                <div class="col-md-6">
                    <div class="banner-shortcode style-6">
                        <img class="image" src="{{ URL::asset('public/img/product-131.jpg')}}" alt="" />
                        <div class="content">
                            <div class="cell-view">
            ...
            <div class="tabs-block">
                ...
                <div class="tab-entry visible">
                    <div class="slider-wrapper">
                        ...
                        <div class="swiper-container arrows-align-top" data-breakpoints="1" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lt-slides="2" data-slides-per-view="3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product-shortcode style-1 big">
                                        <div class="product-label green">best price</div>
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-115.jpg')}}" alt="">
                                ...
                                <div class="swiper-slide">
                                    <div class="product-shortcode style-1 big">
                                        ...
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-116.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                        ...
                                        <div class="price">
                                            ...
                                            <div class="simple-article size-4"><span class="color">$24.00</span> <span class="line-through">$32.00</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product-shortcode style-1 big">
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-117.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-shortcode style-3 big">
                                                ...
                                                <div class="swiper-container" data-loop="1" data-touch="0">
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide">
                                                            <img src="{{ URL::asset('public/img/product-118.jpg')}}" alt="" />
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="{{ URL::asset('public/img/product-119.jpg')}}" alt="" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="empty-space col-xs-b35 col-md-b70"></div>
                            ...
                            <div class="row nopadding">
                                <div class="col-sm-6">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-120.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-6">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-121.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-6">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-122.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-6">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-123.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
           ...
           <div class="swiper-wrapper">
               <div class="swiper-slide">
                    <div class="container">
                        ...
                        <div class="slider-product-preview">
                            <img src="{{ URL::asset('public/img/product-preview-21.png')}}" alt="">
                        </div>
                        <div class="empty-space col-xs-b80 col-sm-b0"></div>
                    </div>
               </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="product-shortcode style-1 float">
                                                ...
                                                <div class="preview">
                                                    <img src="{{ URL::asset('public/img/product-124.jpg')}}" alt="">
                                                    <div class="preview-buttons valign-middle">
                                                        <div class="valign-middle-content">
                                                            <a class="button size-2 style-2" href="#">
                                                                <span class="button-wrapper">
                            ...
                            <div class="row nopadding">
                                <div class="col-sm-6">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-125.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-6">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-126.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                            ...
                            <div class="row nopadding">
                                <div class="col-sm-6">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-127.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-6">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{ URL::asset('public/img/product-128.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="product-shortcode style-1 float">
                                                ...
                                                <div class="preview">
                                                    <img src="{{ URL::asset('public/img/product-129.jpg')}}" alt="">
                                                    <div class="preview-buttons valign-middle">
                                                        <div class="valign-middle-content">
                                                            <a class="button size-2 style-2" href="#">
                                                                <span class="button-wrapper">
            ...
            <div class="row">
                <div class="col-sm-4 col-xs-b25">
                    ...
                    <div class="product-shortcode style-4 light clearfix">
                        <a class="preview" href="#"><img src="{{ URL::asset('public/img/product-31.jpg')}}" alt=""></a>
                        <div class="description">
                    ...
                    <div class="product-shortcode style-4 light clearfix">
                        <a class="preview" href="#"><img src="{{ URL::asset('public/img/product-32.jpg')}}" alt=""></a>
                        <div class="description">
                    ...
                    <div class="product-shortcode style-4 light clearfix">
                        <a class="preview" href="#"><img src="{{ URL::asset('public/img/product-33.jpg')}}" alt=""></a>
                        <div class="description">
                            <div class="simple-article color size-1 col-xs-b5"><a href="#">CASES</a></div>
                ...
                <div class="col-sm-4 col-xs-b25">
                    ...
                    <div class="product-shortcode style-4 light clearfix">
                        <a class="preview" href="#"><img src="{{ URL::asset('public/img/product-34.jpg')}}" alt=""></a>
                        <div class="description">
                            <div class="simple-article color size-1 col-xs-b5"><a href="#">WIRELESS</a></div>
                            <h6 class="h6 col-xs-b10"><a href="#">wireless headphones</a></h6>
                            <div class="simple-article dark">$98.00</div>
                    ...
                    <div class="product-shortcode style-4 light clearfix">
                        <a class="preview" href="#"><img src="{{ URL::asset('public/img/product-35.jpg')}}" alt=""></a>
                        <div class="description">
                            <div class="simple-article color size-1 col-xs-b5"><a href="#">CASES</a></div>
                            <h6 class="h6 col-xs-b10"><a href="#">earphones case</a></h6>
                            <div class="simple-article dark">$12.00</div>
                    ...
                    <div class="product-shortcode style-4 light clearfix">
                        <a class="preview" href="#"><img src="{{ URL::asset('public/img/product-36.jpg')}}" alt=""></a>
                        <div class="description">
                            <div class="simple-article color size-1 col-xs-b5"><a href="#">CASES</a></div>
                            <h6 class="h6 col-xs-b10"><a href="#">headphones case</a></h6>
                            <div class="simple-article dark">$4.00</div>
                ...
                <div class="col-sm-4 col-xs-b25">
                    ...
                    <div class="product-shortcode style-4 light clearfix">
                        <a class="preview" href="#"><img src="{{ URL::asset('public/img/product-37.jpg')}}" alt=""></a>
                        <div class="description">
                            <div class="simple-article color size-1 col-xs-b5"><a href="#">WIRELESS</a></div>
                            <h6 class="h6 col-xs-b10"><a href="#">wireless headphones</a></h6>
                            <div class="simple-article dark">$98.00</div>
                    ...
                    <div class="product-shortcode style-4 light clearfix">
                        <a class="preview" href="#"><img src="{{ URL::asset('public/img/product-38.jpg')}}" alt=""></a>
                        <div class="description">
                            <div class="simple-article color size-1 col-xs-b5"><a href="#">CASES</a></div>
                            <h6 class="h6 col-xs-b10"><a href="#">earphones case</a></h6>
                            <div class="simple-article dark">$12.00</div>
                    ...
                    <div class="product-shortcode style-4 light clearfix">
                        <a class="preview" href="#"><img src="{{ URL::asset('public/img/product-39.jpg')}}" alt=""></a>
                        <div class="description">
                            <div class="simple-article color size-1 col-xs-b5"><a href="#">CASES</a></div>
                            <h6 class="h6 col-xs-b10"><a href="#">headphones case</a></h6>
                            <div class="simple-article dark">$4.00</div>
