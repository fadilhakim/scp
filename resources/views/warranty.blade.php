            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <form class="contact-form" method="post" action="{{url('/admin/warranty/submit')}}">
                        <div class="row m5">
                            <div class="col-sm-6">
                                <input required class="simple-input col-xs-b20" type="text" value="" placeholder="Model Product" name="model" />
                            </div>
                            <div class="col-sm-6" style="position: relative;">
                             ...
                             <div class="col-sm-6">
                                <input required class="simple-input col-xs-b20" type="text" value="" placeholder="Number Imer 1" name="no_imei_1" />
                            </div>

                             <div class="col-sm-6">
                                <input required class="simple-input col-xs-b20" type="text" value="" placeholder="Number Imer 1" name="no_imei_2" />
                            </div>

                            <div class="col-sm-6">
                                <input required class="simple-input col-xs-b20" type="text" value="" placeholder="Customer Email" name="customer_email" />
                            </div>

                            <div class="col-sm-6">
                                <input required class="simple-input col-xs-b20" type="text" value="" placeholder="customer_name" name="customer_name" />
                            </div>

                            <div class="col-sm-6">
                                <input required class="simple-input col-xs-b20" type="text" value="" placeholder="Customer Phone" name="customer_phone" />
                            </div>

                            <div class="col-sm-12">
                                <textarea required class="simple-input col-xs-b20" placeholder="Customer Address " name="customer_address"></textarea>
